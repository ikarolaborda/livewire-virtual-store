...
build:
	export COMPOSE_FILE=docker-compose.yml; docker-compose --env-file .env up -d --build
...
ws:
	docker exec -it php php artisan websockets:serve

npmi:
	docker exec -it php npm install

npmrd:
	docker exec -it php npm run dev
